...
mod tests {
    ...
    fn test_api_documentation_completeness() {
        ...
        assert!(lib_rs.contains("//! # Flow-RS Core"), "lib.rs should have proper module documentation");
    ...
    fn test_error_documentation_completeness() {
        ...
        for variant in &error_variants {
            ...
            assert!(has_doc_comment || has_error_attr, "Should document error variant: {}", variant);
        }
    }
