...
1. **View the Flow**: The example displays a simple flow diagram with three nodes
2. **Interactive Elements**: Use the placeholder controls (future functionality)
3. **Canvas Rendering**: Observe the Canvas2D renderer in action
4. **Background Pattern**: Notice the dotted background pattern
5. **Node Connections**: See how edges are rendered between nodes
...
3. Serve the example with Trunk (in a new terminal):
